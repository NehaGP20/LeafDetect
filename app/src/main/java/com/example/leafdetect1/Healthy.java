...
public class Healthy extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        if(v.equals(btnGoBack)) {
            Intent it = new Intent(Healthy.this,Detection.class);
            startActivity(it);
        } else if(v.equals(btnBuyFert)) {
            Intent it = new Intent(Healthy.this,BuyFertilizers.class);
            startActivity(it);
        }
